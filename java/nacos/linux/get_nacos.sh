...
sed -i 's/static long nextLong(long bound)/static long nextLongBound(long bound)/' client/src/main/java/com/alibaba/nacos/client/naming/utils/JvmRandom.java
