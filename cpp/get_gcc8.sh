...
# wget https://mirror.linux-ia64.org/gnu/gcc/releases/gcc-8.5.0/gcc-8.5.0.tar.gz -O gcc-8.5.0.tar.gz --no-check-certificate
wget https://ftp.gnu.org/gnu/gcc/gcc-8.5.0/gcc-8.5.0.tar.gz -O gcc-8.5.0.tar.gz --no-check-certificate
ls -la gcc-8.5.0.tar.gz
