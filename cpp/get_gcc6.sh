...
# wget https://mirror.linux-ia64.org/gnu/gcc/releases/gcc-6.5.0/gcc-6.5.0.tar.gz -O gcc-6.5.0.tar.gz --no-check-certificate
wget https://ftp.gnu.org/gnu/gcc/gcc-6.5.0/gcc-6.5.0.tar.gz -O gcc-6.5.0.tar.gz --no-check-certificate
ls -la gcc-6.5.0.tar.gz
